...
const Contact = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-full my-24">
      <div className="flex flex-col p-20  ">
        ...
        <div className="flex items-center p-10  my-10">
          <a
            target="_blank"
      ...
      <div className="flex flex-col justify-center content-center p-10 shadow-2xl">
        <iframe
